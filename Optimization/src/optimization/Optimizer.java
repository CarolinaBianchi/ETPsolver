...
public class Optimizer {
    ...
    /**
     * As a new solution is generated by some metaheuristic, compares the cost of the 
     * scheduled obtained in that metaheuristics and if it is lower than the one of the previous best 
     * schedule, it saves the new solution as the best one and writes it.
     * <code>bestSchedule</code> is initialized with cost equal to 0, so the new solution is accepted
     * also if the that initial value is found.
     *
     * @param mySolution
     */
